...
class CalendarView: UIView {
    ...
    private lazy var removeButton: UIButton = {
        ...
        button.addTarget(self, action: #selector(removeButtonTapped(_sender:)), for: .touchUpInside)
        return button
    }()
    ...
    @objc func removeButtonTapped(_sender: UIButton) {
